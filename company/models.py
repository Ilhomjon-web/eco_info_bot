...
class Partner(models.Model):
    partnership_opportunities = models.TextField(verbose_name=_("Hamkorlik imkoniyatlari"))
    partnership_programs = models.TextField(verbose_name=_("Hamkorlik dasturlari"))
    conditions = models.TextField(verbose_name=_("Shartlar"))
...
class ContactInformation(models.Model):
    company_address = models.TextField(verbose_name=_("Kompaniya manzillari"))
